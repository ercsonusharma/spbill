...
function globethree($output,$dbname,$hinttype,$hint,$hinttype2,$hint2,$hinttype3,$hint3)
{
	$query="Select $output from $dbname where $hinttype='$hint' and $hinttype2='$hint2' and $hinttype3='$hint3'";	
	if($query_st=mysql_query($query))
	{
	if($arr=mysql_fetch_array($query_st))
	return $arr[$output];	
