...
<html lang="en" >
<head>
<title>Split Bill | Users-<?php echo $uname; ?></title>
...
<li>Borrow: <?php if(!(isset($borrow))) echo ' NA';else echo " INR ".$borrow; ?></li>--------------------------
<br>
...
{
?>
<h2 style="mar<gin-left:150px;color:red;">OOPS!!!No such user exist.....</h2>
